...
module.exports = function checkinUpdate(FORM) {
    var formu = FORM;
...
module.exports = function getCheckin(FORM) { //
  var formu = [];
...
module.exports = function getQuarto(res){ //
 db.serialize(function() {

  db.all("SELECT * FROM quarto WHERE estado=livre", function(err, rows){
    if (rows == null) {
